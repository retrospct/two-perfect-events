...
const Corporate = ({ location, data }) => {
  ...
  return (
    <Layout location={location} footer={data.footer} nonavigation>
      ...
      <Seo siteSeo={siteSeo} pageSeo={data.corporate.seoMetaTags} />
      <NavSpacer>
        <HeroImage title="CORPORATE" subtitle={data.corporate.subtitle} image={data.corporate.heroImage} />
        {/* <HeroImage title={data.corporate.title} subtitle={data.corporate.subtitle} image={data.corporate.heroImage} /> */}
        {/* <WeddingsBlock blocks={data.corporate.blocks} /> */}
        <HeroImage image={data.corporate.heroBottom} />
        {data.corporate.connectEnabled && <Connect />}
      </NavSpacer>
    </Layout>
  )
}
